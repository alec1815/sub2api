export default {
  ...
  admin: {
    ...
    enterprises: {
      title: '企业管理',
      description: '创建和管理企业，查看成员与余额',
      searchPlaceholder: '搜索企业名称或管理员邮箱...',
      allStatus: '全部状态',
      statusActive: '启用',
      statusDisabled: '禁用',
      columns: {
      ...
      deleteConfirmTitle: '删除企业',
      deleteConfirmMessage: '确定删除企业"{name}"？所有成员将被解绑，密钥将被禁用。',
      activateConfirmTitle: '激活企业',
      activateConfirmMessage: '确定激活企业"{name}"？',
      toggleConfirmTitle: '启停企业',
      toggleEnableMessage: '确定启用企业"{name}"？',
      toggleDisableMessage: '确定禁用企业"{name}"？所有成员密钥将被禁用。',
      noEnterprises: '暂无企业',
      createFirst: '创建第一个企业',
      fields: {
        name: '企业名称',
        namePlaceholder: '例如：示例科技有限公司',
        shortName: '简称',
        shortNamePlaceholder: '企业简称或缩写',
        adminEmail: '管理员邮箱',
        adminEmailPlaceholder: "admin{'@'}example.com",
        adminName: '管理员姓名',
        adminNamePlaceholder: '企业管理员姓名',
        creditCode: '统一社会信用代码',
        creditCodePlaceholder: '统一社会信用代码',
        address: '地址',
        addressPlaceholder: '注册地址',
        scale: '规模',
        scalePlaceholder: '选择规模',
        industry: '行业',
        industryPlaceholder: '选择行业',
        contactName: '联系人',
        contactNamePlaceholder: '主要联系人',
        contactPhone: '联系电话',
      ...
      disable: '禁用',
      activate: '启用',
      disableConfirmTitle: '禁用企业',
      disableConfirmMessage: '确定禁用企业"{name}"？所有成员密钥将被禁用。',
      enableConfirmTitle: '启用企业',
      enableConfirmMessage: '确定启用企业"{name}"？',
      noEnterprisesYet: '暂无企业',
      noEnterprisesHint: '创建您的第一个企业',
      deleteConfirm: '确定删除企业"{name}"？所有成员将被解绑，密钥将被禁用。',
      form: {
        fullName: '企业名称',
        fullNamePlaceholder: '例如：示例科技有限公司',
        shortName: '简称',
        shortNamePlaceholder: '企业简称或缩写',
        adminSection: '管理员信息',
        adminEmail: '管理员邮箱',
        ...
        notes: '备注',
        notesPlaceholder: '内部备注...',
        categorySection: '企业分类',
        fullNameRequired: '请输入企业名称',
        adminEmailRequired: '请输入管理员邮箱',
        adminEmailInvalid: '请输入有效的邮箱地址',
        passwordRequired: '请输入密码',
        passwordInvalid: '密码长度必须为8-20个字符',
      ...
      createHint: '创建企业后，系统将自动生成管理员账号。管理员可登录并管理企业成员与密钥。',
      confirmCreate: '确认创建',
      created: '企业创建成功',
      createSuccess: '企业创建成功',
      updated: '企业更新成功',
      updateSuccess: '企业更新成功',
      statusToggled: '企业状态已更新',
      deleted: '企业已删除',
      failedToLoad: '加载企业列表失败',
      disableSuccess: '企业已禁用',
      activateSuccess: '企业已启用',
      errors: {
        createFailed: '创建企业失败',
        operationFailed: '操作失败',
        alreadyActive: '企业已启用，无需重复操作',
        alreadyDisabled: '企业已禁用，无需重复操作',
      },
    },
    ...
    enterpriseMembers: {
      ...
      registerMember: '注册成员',
      registerFirst: '注册第一个成员',
      editMember: '编辑成员',
      unbindMember: '解绑成员',
      unbindTitle: '解绑成员',
      unbindMessage: '确定解绑成员 {email}？所有密钥将被禁用。',
      unbindConfirm: '确定解绑成员 {name}？',
      confirmCreate: '确认注册',
      noMembers: '该企业暂无成员',
      failedToLoad: '加载成员列表失败',
      fields: {
        email: '邮箱',
        emailPlaceholder: '输入邮箱邀请成员',
        username: '用户名',
        usernamePlaceholder: '留空自动生成',
        password: '密码',
      ...
      updated: '成员更新成功',
      unbound: '成员已解绑',
      invalidEnterprise: '无效的企业 ID',
    },

    departments: {
      title: '部门管理',
      description: '管理企业部门树形结构',
      selectEnterprise: '选择企业',
      selectEnterprisePlaceholder: '请先选择企业',
      selectEnterpriseHint: '选择一个企业以管理部门',
      ...
      deleteConfirmMessage: '确定删除部门"{name}"？子部门将移至父级。',
      deleteTitle: '删除部门',
      deleteConfirm: '确定删除部门 "{name}"？子部门将移至父级。',
      refresh: '刷新',
      noDepartments: '暂无部门',
      createFirst: '创建第一个部门',
      status: {
      ...
      fields: {
        name: '部门名称',
        namePlaceholder: '例如：研发部',
        parentDepartment: '上级部门',
        parentDepartmentPlaceholder: '无（顶级部门）',
        leader: '负责人',
        leaderPlaceholder: '部门负责人姓名',
        phone: '电话',
        phonePlaceholder: '负责人电话',
        email: '邮箱',
        emailPlaceholder: '负责人邮箱',
        sortOrder: '排序',
      },
      form: {
        name: '部门名称',
  ...
  enterpriseProfile: {
    ...
    joinedSince: '加入时间',
    basicsTitle: '基本信息',
    basicsDescription: '企业概览与关键信息',
    contactTitle: '联系信息',
    contactDescription: '企业联系详情',
    usageTitle: '用量概览',
    usageDescription: '您的月度用量概览',
    fields: {
      name: '企业名称',
      shortName: '简称',
      industry: '行业',
  ...
  enterprise: {
    ...
    members: {
      ...
      noMembers: '暂无成员',
      unbindTitle: '解绑成员',
      unbindMessage: '确定解绑成员 {email} 并禁用其企业密钥？',
      fields: {
        email: '邮箱 *',
        emailPlaceholder: '输入成员邮箱',
        username: '用户名',
        usernamePlaceholder: '留空自动生成',
        password: '密码',
        passwordPlaceholder: '留空自动生成',
        department: '部门 ID',
        departmentPlaceholder: '部门 ID（选填）',
        concurrency: '并发数',
        rpmLimit: 'RPM 限制',
        notes: '备注',
        notesPlaceholder: '内部备注...',
    ...
    keys: {
      ...
      disableKey: '禁用密钥',
      enableKey: '启用密钥',
      disableMessage: '确定禁用密钥"{name}"？',
      enableMessage: '确定启用密钥"{name}"？',
      deleteKey: '删除密钥',
      deleteMessage: '确定永久删除密钥"{name}"？此操作不可撤销。',
      keyCreated: '密钥创建成功！请保存下方完整密钥——仅显示一次。',
      keyWarning: '完整密钥仅显示一次，请复制并妥善保管。',
      ...
      fields: {
        name: '密钥名称 *',
        namePlaceholder: '例如：张三的开发密钥',
        groupIds: '分组 ID',
        groupIdsPlaceholder: '逗号分隔，如：1,2,3',
        groupIdsHint: '逗号分隔的分组 ID，留空使用默认值',
        assignedTo: '分配成员 ID',
        assignedToPlaceholder: '成员 ID（选填）',
        usagePurpose: '使用用途',
        usagePurposePlaceholder: '例如：Cursor IDE 开发',
        boundTool: '绑定工具',
        boundToolNone: '无（通用）',
        quota: '配额（美元）',
    ...
    finance: {
      title: '企业财务',
      description: '查看财务概览、用量与订阅',
      currentBalance: '当前余额',
      totalRecharged: '累计充值',
      totalCost: '累计消费',
      subscriptionsTitle: '订阅套餐',
      planName: '套餐',
      groupName: '分组',
      status: '状态',
      dailyUsage: '日用量',
    ...
    settings: {
      title: '企业设置',
      description: '查看和更新企业信息',
      basicInfo: '基本信息',
      basicInfoDescription: '成员可见的企业详情',
      overview: '概览',
      memberCount: '成员数',
      balance: '余额',
      createdAt: '创建时间',
