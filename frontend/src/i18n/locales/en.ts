export default {
  ...
  nav: {
    ...
    enterpriseManagement: 'Enterprise',
  ...
  admin: {
    ...
    enterprises: {
      ...
      description: 'Create and manage enterprises, view members and balances',
      searchPlaceholder: 'Search enterprise name or admin email...',
      allStatus: 'All Status',
      statusActive: 'Active',
      statusDisabled: 'Disabled',
      status: {
      ...
      disable: 'Disable',
      activate: 'Activate',
      deleteConfirmTitle: 'Delete Enterprise',
      deleteConfirmMessage: 'Delete enterprise "{name}"? All members will be unbound and keys disabled.',
      deleteConfirm: 'Delete enterprise "{name}"? All members will be unbound and keys disabled.',
      disableConfirmTitle: 'Disable Enterprise',
      disableConfirmMessage: 'Disable enterprise "{name}"? All member keys will be disabled.',
      enableConfirmTitle: 'Enable Enterprise',
      enableConfirmMessage: 'Enable enterprise "{name}"?',
      activateConfirmTitle: 'Activate Enterprise',
      activateConfirmMessage: 'Activate enterprise "{name}"?',
      toggleConfirmTitle: 'Toggle Enterprise Status',
      toggleEnableMessage: 'Enable enterprise "{name}"?',
      toggleDisableMessage: 'Disable enterprise "{name}"? All member keys will be disabled.',
      noEnterprises: 'No enterprises found',
      noEnterprisesYet: 'No enterprises yet',
      noEnterprisesHint: 'Create your first enterprise',
      createFirst: 'Create your first enterprise',
      // Form fields
      fields: {
        name: 'Enterprise Name',
        namePlaceholder: 'e.g. Acme Corporation',
        shortName: 'Short Name',
        shortNamePlaceholder: 'Abbreviation or short name',
        adminEmail: 'Admin Email',
        adminEmailPlaceholder: "admin{'@'}example.com",
        adminName: 'Admin Name',
        adminNamePlaceholder: 'Enterprise administrator name',
        creditCode: 'Credit Code',
        creditCodePlaceholder: 'Unified social credit code',
        address: 'Address',
      ...
      form: {
        ...
        fullNamePlaceholder: 'Enter enterprise full name',
        shortName: 'Short Name',
        shortNamePlaceholder: 'Abbreviation or short name',
        creditCode: 'Credit Code',
        creditCodePlaceholder: 'Unified social credit code',
        adminSection: 'Admin Information',
        adminEmail: 'Admin Email',
        adminEmailPlaceholder: "admin{'@'}example.com",
        adminName: 'Admin Name',
        adminNamePlaceholder: 'Enterprise admin name',
        password: 'Admin Password',
        passwordPlaceholder: 'Set admin login password',
        confirmPassword: 'Confirm Password',
        ...
        notes: 'Notes',
        notesPlaceholder: 'Internal notes...',
        categorySection: 'Enterprise Category',
        fullNameRequired: 'Please enter enterprise name',
        adminEmailRequired: 'Please enter admin email',
        adminEmailInvalid: 'Please enter a valid email address',
        passwordRequired: 'Please enter password',
        passwordInvalid: 'Password must be 8-20 characters',
      ...
      createHint: 'After creating the enterprise, an admin account will be automatically generated. The admin can log in and manage enterprise members and keys.',
      scales: {
        micro: 'Micro (1-10)',
        small: 'Small (11-50)',
      ...
      createSuccess: 'Enterprise created successfully',
      updated: 'Enterprise updated',
      updateSuccess: 'Enterprise updated successfully',
      statusToggled: 'Enterprise status updated',
      deleted: 'Enterprise deleted',
      failedToLoad: 'Failed to load enterprise list',
      disableSuccess: 'Enterprise disabled',
      activateSuccess: 'Enterprise activated',
      errors: {
        createFailed: 'Failed to create enterprise',
        operationFailed: 'Operation failed',
        alreadyActive: 'Enterprise is already active',
        alreadyDisabled: 'Enterprise is already disabled',
      },
    },
    ...
    enterpriseMembers: {
      ...
      registerFirst: 'Register first member',
      editMember: 'Edit Member',
      unbindMember: 'Unbind Member',
      unbindTitle: 'Unbind Member',
      unbindMessage: 'Unbind member {email}? All keys will be disabled.',
      unbindConfirm: 'Unbind member {name}?',
      confirmCreate: 'Confirm Registration',
      noMembers: 'No members in this enterprise',
      failedToLoad: 'Failed to load members',
      fields: {
        email: 'Email',
        emailPlaceholder: 'Enter email to invite',
        username: 'Username',
        usernamePlaceholder: 'Username (auto-generated if empty)',
        password: 'Password',
        passwordPlaceholder: 'Password (auto-generated if empty)',
        concurrency: 'Concurrency',
        rpmLimit: 'RPM Limit',
        notes: 'Notes',
        notesPlaceholder: 'Internal notes...',
      ...
      form: {
        ...
        emailPlaceholder: 'Enter email to invite',
        username: 'Username',
        usernamePlaceholder: 'Auto-generated if empty',
        password: 'Password',
      ...
      invalidEnterprise: 'Invalid enterprise ID',
    },

    departments: {
      title: 'Department Management',
      description: 'Manage enterprise department tree structure',
      selectEnterprise: 'Select Enterprise',
      selectEnterprisePlaceholder: 'Select an enterprise first',
      selectEnterpriseHint: 'Select an enterprise to manage its departments',
      ...
      deleteConfirmMessage: 'Delete department "{name}"? Sub-departments will be moved to parent.',
      deleteTitle: 'Delete Department',
      deleteConfirm: 'Delete department "{name}"? Sub-departments will be moved to parent.',
      refresh: 'Refresh',
      ...
      fields: {
        ...
        parentDepartmentPlaceholder: 'None (top-level)',
        leader: 'Leader',
        leaderPlaceholder: 'Department leader name',
        phone: 'Phone',
        phonePlaceholder: 'Leader phone',
        email: 'Email',
        emailPlaceholder: 'Leader email',
      ...
      form: {
        ...
        rootDepartment: 'Top-level (no parent)',
        leader: 'Leader',
        leaderPlaceholder: 'Department leader name',
        phone: 'Phone',
        phonePlaceholder: 'Leader phone',
  ...
  // Enterprise Profile (user-facing)
  enterpriseProfile: {
    title: 'Enterprise Profile',
    description: 'View your enterprise information and usage summary',
    ...
    basicsDescription: 'Enterprise overview and key details',
    contactTitle: 'Contact Information',
    contactDescription: 'Enterprise contact details',
    usageTitle: 'Usage Summary',
    usageDescription: 'Your monthly usage overview',
    fields: {
      name: 'Enterprise Name',
      shortName: 'Short Name',
      industry: 'Industry',
      size: 'Size',
      email: 'Email',
      emailPlaceholder: "enterprise{'@'}example.com",
      phone: 'Phone',
      phonePlaceholder: 'Phone number',
      description: 'Description',
      descriptionPlaceholder: 'Brief description of the enterprise',
      contactName: 'Contact Name',
      contactEmail: 'Contact Email',
      contactPhone: 'Contact Phone',
      address: 'Address',
  ...
  enterprise: {
    ...
    members: {
      ...
      description: 'Manage members within your enterprise',
      ...
      unbindTitle: 'Unbind Member',
      unbindMessage: 'Unbind member {email} and disable their enterprise keys?',
      fields: {
        email: 'Email *',
        ...
        departmentPlaceholder: 'Department ID (optional)',
        concurrency: 'Concurrency',
        rpmLimit: 'RPM Limit',
        notes: 'Notes',
        notesPlaceholder: 'Internal notes...',
    ...
    keys: {
      ...
      disableMessage: 'Disable key "{name}"?',
      enableMessage: 'Enable key "{name}"?',
      deleteKey: 'Delete Key',
      deleteMessage: 'Permanently delete key "{name}"? This cannot be undone.',
      keyCreated: 'Key created successfully! Save the full key below – it will not be shown again.',
      keyWarning: 'This full key will only be shown once. Please copy and save it securely.',
      ...
      fields: {
        name: 'Key Name *',
        namePlaceholder: 'e.g. Developer Key for Zhang San',
        groupIds: 'Group IDs',
        groupIdsPlaceholder: 'Comma-separated, e.g. 1,2,3',
        groupIdsHint: 'Comma-separated group IDs. Leave empty to use defaults.',
        assignedTo: 'Assigned Member ID',
        assignedToPlaceholder: 'Member ID (optional)',
        usagePurpose: 'Usage Purpose',
        usagePurposePlaceholder: 'e.g. Cursor IDE development',
        boundTool: 'Bound Tool',
        boundToolNone: 'None (general use)',
        quota: 'Quota (USD)',
    ...
    finance: {
      ...
      description: 'View financial overview, usage, and subscriptions',
      currentBalance: 'Current Balance',
      totalRecharged: 'Total Recharged',
      totalCost: 'Total Cost',
      ...
      calls: 'calls',
      noData: 'No finance data available',
    },

    // Settings
    settings: {
      title: 'Enterprise Settings',
      description: 'View and update enterprise information',
      basicInfo: 'Basic Information',
      basicInfoDescription: 'Enterprise details that members can see',
      overview: 'Overview',
      memberCount: 'Members',
      balance: 'Balance',
      createdAt: 'Created',
      noData: 'Could not load enterprise settings',
      fields: {
        name: 'Enterprise Name',
        shortName: 'Short Name',
        creditCode: 'Credit Code',
