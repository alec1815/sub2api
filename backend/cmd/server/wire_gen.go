...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	enterpriseHandler := admin.NewEnterpriseHandler(enterpriseService, apiKeyRepository, enterpriseKeyService)
	...
	enterpriseDashboardHandler := enterprise.NewEnterpriseDashboardHandler(dashboardService)
	enterpriseHandlers := handler.ProvideEnterpriseHandlers(memberHandler, keyHandler, departmentHandler, billingHandler, profileHandler, enterpriseDashboardHandler)
