...
func (_q *DepartmentQuery) QueryEnterprise() *EnterpriseQuery {
...
func (_q *DepartmentQuery) QueryMembers() *EnterpriseMemberQuery {
...
func (_q *DepartmentQuery) WithEnterprise(opts ...func(*EnterpriseQuery)) *DepartmentQuery {
	query := (&EnterpriseClient{config: _q.config}).Query()
...
func (_q *DepartmentQuery) WithMembers(opts ...func(*EnterpriseMemberQuery)) *DepartmentQuery {
	query := (&EnterpriseMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Department, error) {
	...
	if query := _q.withEnterprise; query != nil {
		if err := _q.loadEnterprise(ctx, query, nodes, nil,
			func(n *Department, e *Enterprise) { n.Edges.Enterprise = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withMembers; query != nil {
		if err := _q.loadMembers(ctx, query, nodes,
			func(n *Department) { n.Edges.Members = []*EnterpriseMember{} },
			func(n *Department, e *EnterpriseMember) { n.Edges.Members = append(n.Edges.Members, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DepartmentQuery) loadEnterprise(ctx context.Context, query *EnterpriseQuery, nodes []*Department, init func(*Department), assign func(*Department, *Enterprise)) error {
...
func (_q *DepartmentQuery) loadMembers(ctx context.Context, query *EnterpriseMemberQuery, nodes []*Department, init func(*Department), assign func(*Department, *EnterpriseMember)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(enterprisemember.FieldDepartmentID)
	}
...
func (_q *DepartmentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withEnterprise != nil {
			_spec.Node.AddColumnOnce(department.FieldEnterpriseID)
		}
	}
