...
type UsageLogRepository interface {
	...
	GetUsageTrendWithFilters(ctx context.Context, startTime, endTime time.Time, granularity string, userID, apiKeyID, accountID, groupID, enterpriseID int64, model string, requestType *int16, stream *bool, billingType *int8) ([]usagestats.TrendDataPoint, error)
	GetModelStatsWithFilters(ctx context.Context, startTime, endTime time.Time, userID, apiKeyID, accountID, groupID, enterpriseID int64, requestType *int16, stream *bool, billingType *int8) ([]usagestats.ModelStat, error)
	...
	GetUserUsageTrend(ctx context.Context, startTime, endTime time.Time, granularity string, enterpriseID int64, limit int) ([]usagestats.UserUsageTrendPoint, error)
